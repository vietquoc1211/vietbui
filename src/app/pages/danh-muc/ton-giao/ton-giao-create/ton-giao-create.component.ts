...
@Component({
  templateUrl: "./ton-giao-create.component.html",
})
export class TonGiaoCreateComponent {
  public isLoading: boolean = false;
  public issave: boolean = false;
  private API = '/api/DMTonGiao';
  public formdata: FormGroup;
  private vali_const = ValidatorConstants;
  public const_data: any = {};
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<TonGiaoCreateComponent>,
  ...
  createform() {
    this.formdata = new FormGroup({
      TenTonGiao: new FormControl('', [Validators.required, Validators.maxLength(256)]),
      Lock: new FormControl(false)
    });
  }
  setvalueform(values) {
    this.formdata.controls['TenTonGiao'].setValue(values.TenTonGiao);
  ...
  savedata(values) {
    ...
    this.issave = true;
    this.const_data.TenTonGiao = values.TenTonGiao;
